(function () {
    ...
    }; ko.validation.rules.min = { validator: function (a, b) { return d.isEmptyVal(a) || a >= b }, message: "Please enter a value greater than or equal to {0}." }; ko.validation.rules.max = { validator: function (a, b) { return d.isEmptyVal(a) || a <= b }, message: "Please enter a value less than or equal to {0}." }; ko.validation.rules.minLength = { validator: function (a, b) { return d.isEmptyVal(a) || a.length >= b }, message: "Please enter at least {0} characters." };
    ...
    }; ko.validation.rules.date = { validator: function (a, b) { return d.isEmptyVal(a) || b && !/Invalid|NaN/.test(new Date(a)) }, message: "Please enter a proper date" }; ko.validation.rules.dateISO = { validator: function (a, b) { return d.isEmptyVal(a) || b && /^\d{4}[\/-]\d{1,2}[\/-]\d{1,2}$/.test(a) }, message: "Please enter a proper date" }; ko.validation.rules.number = { validator: function (a, b) { return d.isEmptyVal(a) || b && /^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:\.\d+)?$/.test(a) }, message: "Please enter a number" };
